...
export default function Footer() {
  return (
    <footer className="bg-[#29304A] text-white flex flex-col justify-center items-center p-4 md:p-8">
      <div className="max-w-[1280px] flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-8 lg:space-y-0">
        ...
        <div className="flex flex-col items-center lg:items-start space-y-4">
          ...
          <div className="flex justify-center items-center space-x-6">
            <Link to="https://www.linkedin.com/company/coral-gables-trust-company/" className="hover:opacity-80 transition-opacity">
              <img src="/src/assets/icons/social-icons/LinkedIn.svg" className="w-[36px] h-[36px]" />
              <span className="sr-only">LinkedIn</span>
            </Link>
            <Link to="https://www.facebook.com/CoralGablesTrust/" className="hover:opacity-80 transition-opacity">
              <img src="/src/assets/icons/social-icons/Facebook.svg" className="w-[36px] h-[36px]" />
              <span className="sr-only">Facebook</span>
            </Link>
            <Link to="https://x.com/CGTrust" className="hover:opacity-80 transition-opacity">
              <img src="/src/assets/icons/social-icons/X.svg" className="w-[36px] h-[36px]" />
              <span className="sr-only">Twitter</span>
            </Link>
            <Link to="https://www.instagram.com/coralgablestrust/" className="hover:opacity-80 transition-opacity">
              <img src="/src/assets/icons/social-icons/Instagram.svg" className="w-[36px] h-[36px]" />
              <span className="sr-only">Instagram</span>
            </Link>
            <Link to="https://www.youtube.com/channel/UCAB_5qktOJcxZDgbe48dJug" className="hover:opacity-80 transition-opacity">
